    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="<?= base_url('index.php/operator/siswa/download')?>" enctype="multipart/form-data">
...
<script>
   $(document).ready(function() {
	...
	$("#kelas").on("change",function(){
		...
		$.ajax({
			method:"POST",
			url:"<?= base_url('index.php/operator/siswa/get_provinsi') ?>",
			data:{kelas:$(this).val()},
	...
	$("#provinsi").on("change",function(){
		...
		$.ajax({
			method:"POST",
			url:"<?= base_url('index.php/operator/siswa/get_kota') ?>",
			data:{
					prov_id:$(this).val(),
					kelas:$("#kelas").val(),
				},
	...
	$("#filter").click(function(){
		$.ajax({
			method:"POST",
			url:"<?= base_url('index.php/operator/siswa/get_table_siswa') ?>",
			data:{
